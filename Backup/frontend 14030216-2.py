...
def admin_logged_in():
    ...
    add_employee_button = Button(
        employee_frame_tab, text="Add Employee", width=15, command=lambda: add_employee_button_clicked(employee_tab)
    )

    add_employee_button.grid(row=4, column=0, padx=(0, 10), pady=5)
    employee_list_button = Button(employee_frame_tab, text="List of Employees", width=15, command="")  #
    # TODO: Write code.
    employee_list_button.grid(row=4, column=1, padx=(0, 10), pady=5)
    search_employee_button = Button(employee_frame_tab, text="Search", width=15, command="")  # TODO: Write code.
